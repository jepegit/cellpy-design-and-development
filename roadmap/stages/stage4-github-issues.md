...
## 2. Epic A — Batch v3 ([batch redesign plan](../../archive/redesigns/cellpy2-batch-redesign-plan.md))
...
## 3. Epic B — Collectors ([collectors redesign plan](../../archive/redesigns/cellpy2-collectors-redesign-plan.md))
...
## 4. Epic C — Utils waves 3–4 ([utils plan](../../archive/redesigns/cellpy2-utils-migration-plan.md) §2–3)
...
| C2 | **→ 2.2** (design captured). **Wave 4** live/incremental. The core primitives already exist (`update_core_data`/`merge_core_data`); the missing pieces are the `SupportsIncrementalLoad` loader protocol + `CellpyCell.update()` + `live.py` rebuild — a cross-package feature. Full design: [cellpy2-live-incremental-design.md](../../active/cellpy2-live-incremental-design.md) | wave 4, G10 |
...
## 5. Epic D — F6 feature menu ([utils plan](../../archive/redesigns/cellpy2-utils-migration-plan.md) §1.4/wave 4, [gap analysis F6](../cellpy2-plans-gap-analysis.md))
...
## 6. Epic E — Shim removals ([conventions plan](../../ecosystem/cellpy2-conventions-plan.md) §3)
