...
[Step 7](../archive/foundations/cellpy2-metadata-handling-plan.md) "DB/API (JSON-LD) — deferred, but keep the door
...
loader contract ([architecture §5](../roadmap/cellpy2-architecture-plan.md)): a `typing.Protocol` +
