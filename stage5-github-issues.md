...
The flagship, fully specified in **[cellpy2-live-incremental-design.md](cellpy2-live-incremental-design.md)**
...
contract ([loader plan](cellpy2-loader-port-and-extraction-plan.md)); each ships a golden
